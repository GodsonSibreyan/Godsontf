...
provisioner "local-exec" {
    command = "echo ${aws_instance.Appserver1.public_ip} >> /var/lib/jenkins/workspace/DjangoMultiChoice/publicip1"
}
}
...
provisioner "local-exec" {
    command = "echo ${aws_instance.Appserver2.public_ip} >> /var/lib/jenkins/workspace/DjangoMultiChoice/publicip2"
}
}
